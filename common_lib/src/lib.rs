...
mod tests {
    ...
    fn response_wrapper_test() {
        ...
        assert_eq!(response.get_code(), WrapperErrEnum::Success.into() as i32);
        ...
        assert_eq!(fail.get_code(), WrapperErrEnum::Fail.into() as i32);
        ...
        assert_eq!(
            ...
            WrapperErrEnum::UnknownError.into() as i32
        );
    ...
    fn object_wrapper_test() {
        ...
        assert_eq!(data.get_base().get_code(), WrapperErrEnum::Success.into() as i32);
        ...
        assert_eq!(fail_data.get_base().get_code(), WrapperErrEnum::Fail.into() as i32);
    ...
    fn page_wrapper_test() {
        ...
        assert_eq!(
            ...
            WrapperErrEnum::Fail.into() as i32
        );
